defmodule EligonWeb.UserAuthTest do
  use EligonWeb.ConnCase, async: true

  alias Eligon.Users
  alias EligonWeb.UserAuth
  import Eligon.UsersFixtures

  @remember_me_cookie "_eligon_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EligonWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      EligonWeb.Endpoint.subscribe(live_socket_id)
